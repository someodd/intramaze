...
api method route action = method (Web.Scotty.Internal.Types.Capture . pack $ apiRoute route :: Web.Scotty.Internal.Types.RoutePattern) action

apiRoute :: String -> String
apiRoute oldRoute = "/api/v" ++ show restApiVersionMajor ++ oldRoute
